...
class Trainer:
    ...
    def train(self, train_data_loader, test_data_loader, num_epochs, learning_rate, eval_dict, list_of_vids, args,
              test_split,early_stop=8, loss_factor=0.15, T=16, task_factor=[1,1,1]):
